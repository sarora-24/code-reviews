...
def initialize_tables():
    ...
    query = """
        WITH user_emails AS (
            # registered email but no orders as of date, is this new email though? Could be old, never ordered
            SELECT DISTINCT
            ...
            # subscribed to webstaurant mails but no orders as of date and not registered with webstaruant
            SELECT DISTINCT
